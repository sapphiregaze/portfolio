...
const projects = [
  {
    title: "Syntinel Nyx",
    description:
      "IT Automation Platform for Simplified Asset Management, Vulnerability Detection, and Patch Application.",
  ...
  },
  {
    title: "Reverie",
    description:
      "Cross-Platform Application That Gamifies Self-Care and Productivity.",
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] dark:bg-[#121212] font-mono text-black dark:text-white">
      <section className="container mx-auto px-4 pt-32 pb-20">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            <Button
              className="rounded-none border-2 border-black dark:border-white bg-black dark:bg-white text-white dark:text-black hover:bg-white hover:text-black dark:hover:bg-black dark:hover:text-white transition-colors"
              asChild
            >
      ...
      <section
        id="about"
        className="container mx-auto px-4 py-20 border-t border-black dark:border-white"
      >
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <p className="mb-4 leading-relaxed">
                I&apos;m a developer with a passion for creating clean,
                functional, and secure software for both myself and others. I
                enjoy working in web development as well systems-level
                programming. I love programming in general and am looking
                forward to exploring new fields!
              </p>
      ...
      <Button
        ...
        variant="outline"
        className={cn(
          "fixed bottom-6 right-6 p-3 rounded-none border-2 border-black dark:border-white dark:bg-black hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all duration-300 shadow-lg",
          showButton
